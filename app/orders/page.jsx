    ...
    {["cart", "checkout", "payment"].map((status, index) => (
      <div
        ...
        className={`flex items-center ${
          index <= ["cart", "checkout", "payment", "confirmation"].indexOf(step)
            ? "text-indigo-600"
            : "text-gray-400"
        } whitespace-nowrap`}
      >
        <motion.div
          ...
          className={`w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center mr-1 sm:mr-2 ${
            index <=
            ["cart", "checkout", "payment", "confirmation"].indexOf(step)
    ...
    <div className="bg-gradient-to-br from-indigo-50 to-purple-100 min-h-screen">
      <div className="container mx-auto px-4 py-6 sm:py-8">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 text-indigo-800">
